...
DEFAULT_POLICY_SOURCE='optimization-results/LowerOmo/01/ParetoBestX.txt'
...
hw-simulation --config_file model/config.yaml \
    ...
    # --policy_source 'optimization-results/LowerOmo/01/ParetoBestX.txt' \
